...
(function () {
    ...
    function findTextAt(point) {
        try {
            ...
            if (result && result.item) {
                ...
                if (candidate instanceof paper.PointText) return candidate;
            }
        } catch (e) {}
        try {
    ...
    function currentPanelFontFamily() {
        ...
        if (ff.value === '__custom__') {
            return normalizeCustomFontFamily((document.getElementById('tp-font-custom') || {}).value) || undefined;
        }
        return ff.value;
    }
    ...
    function refreshTypePanel(passedItem) {
        ...
        var customInput = document.getElementById('tp-font-custom');
    ...
    document.addEventListener('mousedown', function (e) {
        ...
        if (controlBar && controlBar.contains(e.target)) return;
        commitTypeEditing();
    }, true);
    ...
    whenReady(function () {
        ...
        customInput?.addEventListener('change', function () {
            var val = normalizeCustomFontFamily(this.value);
